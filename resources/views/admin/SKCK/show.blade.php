            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    @if ($skck->pengajuan->scan_ktp)
                        <a href="{{ asset('storage/'.$skck->pengajuan->scan_ktp) }}" class="btn btn-sm btn-outline-secondary" target="_blank" rel="noopener noreferer">
                            Lihat KTP
                        </a>
                    @else
                        <i>Tidak ada KTP</i>
                ...
                <div class="form-group">
                    ...
                    @if ($skck->pengajuan->scan_kk)
                        <a href="{{ asset('storage/'.$skck->pengajuan->scan_kk) }}" class="btn btn-sm btn-outline-secondary" target="_blank" rel="noopener noreferer">
                            Lihat KK
                        </a>
                    @else
                        <i>Tidak ada KK</i>
                ...
                <div class="form-group">
                    ...
                    @if ($skck->pengajuan->scan_akta)
                        <a href="{{ asset('storage/'.$skck->pengajuan->scan_akta) }}" class="btn btn-sm btn-outline-secondary" target="_blank" rel="noopener noreferer">
